...
{
    public class BackSide : IDescriptionCalculator<SpineDescription>
    {
        ...
        public BackSide(SpineDescription description) {
            ...
            names["h_a"] = "Высота правого контура";
            keys.Add("h_a");

            param = new RightSideCalculator();
            param.Description = description;
            parameters["h_b"] = param;
            names["h_b"] = "Высота левого контура";
            keys.Add("h_b");
