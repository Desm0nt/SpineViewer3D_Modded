...
{
    public class FrontSide : IDescriptionCalculator<InterspineDescription>
    {
        ...
        public FrontSide(InterspineDescription description) {
            ...
            names["d_1"] = "Высота левого контура";
            keys.Add("d_1");
            ...
            names["d_2"] = "Высота правого контура";
            keys.Add("d_2");
